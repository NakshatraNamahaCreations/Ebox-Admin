...
function EditTeam() {
  ...
  useEffect(() => {
    if (member) {
      ...
      setDashboard(member.dashboard || false);
      setBanner(member.banner || false);
      setBookingManagement(member.booking_management || false);
      setVendorManagement(member.vendor_management || false);
      setTeamManagement(member.team_management || false);
      setUserManagement(member.user_management || false);
    }
  }, [member]);
