...
function PayoutDetails() {
  ...
  const commissionAmount = parseFloat(
    (payouts.payment_amount * (payouts.commission_percentage / 100)).toFixed(2)
  );
  const commissionTax = parseFloat(
    (commissionAmount * (payouts.commission_tax / 100)).toFixed(2)
  );
  const payoutsAmount = parseFloat(
      ...
      >
        ...
        >
          ...
          <tr style={styles.tableRow}>
            ...
            <td style={styles.tableData}>
              {payouts.event_id.slice(-6).toUpperCase()}
            </td>
          </tr>
          <tr style={styles.tableRow}>
          ...
          <tr style={styles.tableRow}>
            ...
            <td style={styles.tableData}>{payouts.commission_percentage}%</td>
          </tr>
          <tr style={styles.tableRow}>
            <th style={styles.tableHeader}>Commission ₹ </th>
          ...
          <tr style={styles.tableRow}>
            ...
            <td style={styles.tableData}>{payouts.commission_tax}%</td>
          </tr>
          <tr style={styles.tableRow}>
            <th style={styles.tableHeader}>Commission Tax ₹ </th>
